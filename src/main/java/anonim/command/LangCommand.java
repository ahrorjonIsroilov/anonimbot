...
public class LangCommand extends TextCommand {
    public LangCommand(BotService service, SessionUserRepository repository) {
    ...
    protected void handle(Update update) {
        ...
        session.setElement(SessionElement.MESSAGE_ID, getMessage(update).getMessageId(), chatId);
